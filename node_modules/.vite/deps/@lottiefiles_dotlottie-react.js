...
var J3 = (d, i, r) => i in d ? q3(d, i, { enumerable: true, configurable: true, writable: true, value: r }) : d[i] = r;
var v = (d, i, r) => J3(d, typeof i != "symbol" ? i + "" : i, r);
var Y3 = class {
...
var Z3 = class {
  constructor() {
    v(this, "_lastHandleId", 0), v(this, "_lastImmediate", null);
  }
  requestAnimationFrame(d) {
...
var G3 = class {
  constructor() {
    v(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new Y3() : new Z3();
  }
  requestAnimationFrame(d) {
...
var A = typeof window < "u" && typeof window.document < "u";
...
var i0 = (() => {
  ...
  return function(i = {}) {
    var r, s = i, p, P, z = new Promise((t, e) => {
      p = t, P = e;
    ...
    var K = s.wasmBinary, q, s1 = false, h1, B, M, t1, J, L, w, f1, _1;
    function i1() {
      var t = q.buffer;
      s.HEAP8 = B = new Int8Array(t), s.HEAP16 = t1 = new Int16Array(t), s.HEAPU8 = M = new Uint8Array(t), s.HEAPU16 = J = new Uint16Array(t), s.HEAP32 = L = new Int32Array(t), s.HEAPU32 = w = new Uint32Array(t), s.HEAPF32 = f1 = new Float32Array(t), s.HEAPF64 = _1 = new Float64Array(t);
    }
    var E1 = [], H = [], v1 = [];
    function K2() {
    ...
    var a1 = 0, m1 = null;
    function D1(t) {
      throw s.onAbort?.(t), t = "Aborted(" + t + ")", $(t), s1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), P(t), t;
    }
    var v2 = (t) => t.startsWith("data:application/octet-stream;base64,"), F1;
    async function t3(t) {
      if (!K) try {
        var e = await l1(t);
    ...
    async function e3(t, e) {
      try {
        ...
        $(`failed to asynchronously prepare wasm: ${n}`), D1(n);
      }
    }
    async function i3(t) {
      var e = F1;
    ...
    class m2 {
      constructor(e) {
        v(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${e})`, this.status = e;
      }
    }
    var N1 = (t) => {
    ...
    var a3 = () => {
      ...
      for (var o of t) {
        if (o === 0 || o === n) break;
        if ($2(o, n, a.Pa + 16)) return I1(o), e;
      }
      return I1(n), e;
    }, g1 = (t, e, a) => {
      var n = M;
    ...
    function n3(t, e, a = {}) {
      ...
      n1[t] = e, delete k1[t], c1.hasOwnProperty(t) && (e = c1[t], delete c1[t], e.forEach((o) => o()));
    }
    function V(t, e, a = {}) {
      return n3(t, e, a);
    }
    var J1 = (t) => {
      throw new g(t.Oa.Ra.Qa.name + " instance already deleted");
    }, Y1 = false, y2 = () => {
    }, L2 = (t, e, a) => e === a ? t : a.Ua === void 0 ? null : (t = L2(t, e, a.Ua), t === null ? null : a.ob(t)), C2 = {}, r3 = {}, o3 = (t, e) => {
      if (e === void 0) throw new g("ptr should not be undefined");
      for (; t.Ua; ) e = t.eb(e), t = t.Ua;
      return r3[e];
    }, T1 = (t, e) => {
      if (!e.Ra || !e.Pa) throw new y1("makeClassHandle requires ptr and ptrType");
      if (!!e.Va != !!e.Ta) throw new y1("Both smartPtrType and smartPtr must be specified");
      return e.count = { value: 1 }, L1(Object.create(t, { Oa: { value: e, writable: true } }));
    }, L1 = (t) => typeof FinalizationRegistry > "u" ? (L1 = (e) => e, t) : (Y1 = new FinalizationRegistry((e) => {
      e = e.Oa, --e.count.value, e.count.value === 0 && (e.Ta ? e.Va.Ya(e.Ta) : e.Ra.Qa.Ya(e.Pa));
    }), L1 = (e) => {
      var a = e.Oa;
      return a.Ta && Y1.register(e, { Oa: a }, e), e;
    }, y2 = (e) => {
      Y1.unregister(e);
    }, L1(t));
    function R1() {
    ...
    var C1 = (t, e) => Object.defineProperty(e, "name", { value: t }), b2 = (t, e, a) => {
      if (t[e].Sa === void 0) {
        var n = t[e];
        t[e] = function(...o) {
          if (!t[e].Sa.hasOwnProperty(o.length)) throw new g(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Sa})!`);
          return t[e].Sa[o.length].apply(this, o);
        }, t[e].Sa = [], t[e].Sa[n.ab] = n;
      }
    }, Z1 = (t, e, a) => {
      if (s.hasOwnProperty(t)) {
        if (a === void 0 || s[t].Sa !== void 0 && s[t].Sa[a] !== void 0) throw new g(`Cannot register public name '${t}' twice`);
        if (b2(s, t, t), s[t].Sa.hasOwnProperty(a)) throw new g(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        s[t].Sa[a] = e;
      } else s[t] = e, s[t].ab = a;
    }, s3 = (t) => {
    ...
    function h3(t, e, a, n, o, h, l, c) {
      this.name = t, this.constructor = e, this.$a = a, this.Ya = n, this.Ua = o, this.qb = h, this.eb = l, this.ob = c, this.xb = [];
    }
    var G1 = (t, e, a) => {
      for (; e !== a; ) {
        if (!e.eb) throw new g(`Expected null or instance of ${a.name}, got an instance of ${e.name}`);
        t = e.eb(t), e = e.Ua;
      }
      return t;
    };
    function d3(t, e) {
      if (e === null) {
        if (this.hb) throw new g(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!e.Oa) throw new g(`Cannot pass "${a2(e)}" as a ${this.name}`);
      if (!e.Oa.Pa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return G1(e.Oa.Pa, e.Oa.Ra.Qa, this.Qa);
    }
    function c3(t, e) {
      if (e === null) {
        if (this.hb) throw new g(`null is not a valid ${this.name}`);
        if (this.gb) {
          var a = this.ib();
          return t !== null && t.push(this.Ya, a), a;
        }
        return 0;
      }
      if (!e || !e.Oa) throw new g(`Cannot pass "${a2(e)}" as a ${this.name}`);
      if (!e.Oa.Pa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.fb && e.Oa.Ra.fb) throw new g(`Cannot convert argument of type ${e.Oa.Va ? e.Oa.Va.name : e.Oa.Ra.name} to parameter type ${this.name}`);
      if (a = G1(e.Oa.Pa, e.Oa.Ra.Qa, this.Qa), this.gb) {
        if (e.Oa.Ta === void 0) throw new g("Passing raw pointer to smart pointer is illegal");
        switch (this.Cb) {
          case 0:
            if (e.Oa.Va === this) a = e.Oa.Ta;
            else throw new g(`Cannot convert argument of type ${e.Oa.Va ? e.Oa.Va.name : e.Oa.Ra.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = e.Oa.Ta;
            break;
          case 2:
            if (e.Oa.Va === this) a = e.Oa.Ta;
              ...
              var n = e.clone();
              a = this.yb(a, x1(() => n.delete())), t !== null && t.push(this.Ya, a);
            }
            break;
          default:
    ...
    function l3(t, e) {
      ...
      if (!e.Oa) throw new g(`Cannot pass "${a2(e)}" as a ${this.name}`);
      if (!e.Oa.Pa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Oa.Ra.fb) throw new g(`Cannot convert argument of type ${e.Oa.Ra.name} to parameter type ${this.name}`);
      return G1(e.Oa.Pa, e.Oa.Ra.Qa, this.Qa);
    }
    function b1(t, e, a, n, o, h, l, c, u, f, _) {
      this.name = t, this.Qa = e, this.hb = a, this.fb = n, this.gb = o, this.wb = h, this.Cb = l, this.mb = c, this.ib = u, this.yb = f, this.Ya = _, o || e.Ua !== void 0 ? this.toWireType = c3 : (this.toWireType = n ? d3 : l3, this.Xa = null);
    }
    var M2 = (t, e, a) => {
      if (!s.hasOwnProperty(t)) throw new y1("Replacing nonexistent public symbol");
      s[t].Sa !== void 0 && a !== void 0 ? s[t].Sa[a] = e : (s[t] = e, s[t].ab = a);
    }, D, u3 = (t, e, a = []) => (t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, s["dynCall_" + t])(e, ...a)) : e = D.get(e)(...a), e), f3 = (t, e) => (...a) => u3(t, e, a), W = (t, e) => {
      t = O(t);
      var a = t.includes("j") ? f3(t, e) : D.get(e);
      ...
      function a(h) {
        o[h] || n1[h] || (k1[h] ? k1[h].forEach(a) : (n.push(h), o[h] = true));
      }
      var n = [], o = {};
    ...
    function _3(t) {
      for (var e = 1; e < t.length; ++e) if (t[e] !== null && t[e].Xa === void 0) return true;
      return false;
    }
    function t2(t, e, a, n, o) {
      var h = e.length;
      if (2 > h) throw new g("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var l = e[1] !== null && a !== null, c = _3(e), u = e[0].name !== "void", f = h - 2, _ = Array(f), m = [], C = [];
      return C1(t, function(...U) {
        if (C.length = 0, m.length = l ? 2 : 1, m[0] = o, l) {
          var I = e[1].toWireType(C, this);
          m[1] = I;
        }
        for (var S = 0; S < f; ++S) _[S] = e[S + 2].toWireType(C, U[S]), m.push(_[S]);
        if (U = n(...m), c) q1(C);
        else for (S = l ? 1 : 2; S < e.length; S++) {
          var Q = S === 1 ? I : _[S - 2];
          e[S].Xa !== null && e[S].Xa(Q);
        }
        return I = u ? e[0].fromWireType(U) : void 0, I;
      });
    }
    var S2 = (t) => {
      t = t.trim();
      ...
      var e = W1(t);
      return i2(t), e;
    }, toWireType: (t, e) => x1(e), Wa: 8, readValueFromPointer: w1, Xa: null }, v3 = (t, e, a) => {
      switch (e) {
        case 1:
          return a ? function(n) {
    ...
    }, g3 = Object.assign({ optional: true }, E2), D2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, w3 = (t, e) => {
      for (var a = t >> 1, n = a + e / 2; !(a >= n) && J[a]; ) ++a;
      if (a <<= 1, 32 < a - t && D2) return D2.decode(M.subarray(t, a));
      for (a = "", n = 0; !(n >= e / 2); ++n) {
        var o = t1[t + 2 * n >> 1];
        if (o == 0) break;
      ...
      return a;
    }, S3 = Reflect.construct, M1 = {}, O2 = (t) => {
      if (!(t instanceof m2 || t == "unwind")) throw t;
    }, k2 = (t) => {
      throw h1 = t, X1 || 0 < n2 || (s.onExit?.(t), s1 = true), new m2(t);
    }, E3 = (t) => {
      if (!s1) try {
        if (t(), !(X1 || 0 < n2)) try {
          h1 = t = h1, k2(t);
    ...
    for (var A2 = Array(256), U1 = 0; 256 > U1; ++U1) A2[U1] = String.fromCharCode(U1);
    w2 = A2, g = s.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Object.assign(R1.prototype, { isAliasOf: function(t) {
      if (!(this instanceof R1 && t instanceof R1)) return false;
      var e = this.Oa.Ra.Qa, a = this.Oa.Pa;
      t.Oa = t.Oa;
      var n = t.Oa.Ra.Qa;
      for (t = t.Oa.Pa; e.Ua; ) a = e.eb(a), e = e.Ua;
      for (; n.Ua; ) t = n.eb(t), n = n.Ua;
      return e === n && a === t;
    }, clone: function() {
      if (this.Oa.Pa || J1(this), this.Oa.cb) return this.Oa.count.value += 1, this;
      var t = L1, e = Object, a = e.create, n = Object.getPrototypeOf(this), o = this.Oa;
      return t = t(a.call(e, n, { Oa: { value: { count: o.count, bb: o.bb, cb: o.cb, Pa: o.Pa, Ra: o.Ra, Ta: o.Ta, Va: o.Va } } })), t.Oa.count.value += 1, t.Oa.bb = false, t;
    }, delete() {
      if (this.Oa.Pa || J1(this), this.Oa.bb && !this.Oa.cb) throw new g("Object already scheduled for deletion");
      y2(this);
      var t = this.Oa;
      --t.count.value, t.count.value === 0 && (t.Ta ? t.Va.Ya(t.Ta) : t.Ra.Qa.Ya(t.Pa)), this.Oa.cb || (this.Oa.Ta = void 0, this.Oa.Pa = void 0);
    }, isDeleted: function() {
      return !this.Oa.Pa;
    }, deleteLater: function() {
      if (this.Oa.Pa || J1(this), this.Oa.bb && !this.Oa.cb) throw new g("Object already scheduled for deletion");
      return this.Oa.bb = true, this;
    } }), Object.assign(b1.prototype, { rb(t) {
      return this.mb && (t = this.mb(t)), t;
    }, kb(t) {
      this.Ya?.(t);
    }, Wa: 8, readValueFromPointer: w1, fromWireType: function(t) {
      function e() {
        return this.gb ? T1(this.Qa.$a, { Ra: this.wb, Pa: a, Va: this, Ta: t }) : T1(this.Qa.$a, { Ra: this, Pa: t });
      }
      var a = this.rb(t);
      if (!a) return this.kb(t), null;
      var n = o3(this.Qa, a);
      if (n !== void 0) return n.Oa.count.value === 0 ? (n.Oa.Pa = a, n.Oa.Ta = t, n.clone()) : (n = n.clone(), this.kb(t), n);
      if (n = this.Qa.qb(a), n = C2[n], !n) return e.call(this);
      n = this.fb ? n.nb : n.pointerType;
      var o = L2(a, this.Qa, n.Qa);
      return o === null ? e.call(this) : this.gb ? T1(n.Qa.$a, { Ra: n, Pa: o, Va: this, Ta: t }) : T1(n.Qa.$a, { Ra: n, Pa: o });
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var O3 = { d: (t, e, a, n) => D1(`Assertion failed: ${t ? p1(M, t) : ""}, at: ` + [e ? e ? p1(M, e) : "" : "unknown filename", a, n ? n ? p1(M, n) : "" : "unknown function"]), c: () => a3(), n: (t, e, a) => {
      var n = new g2(t);
      throw w[n.Pa + 16 >> 2] = 0, w[n.Pa + 4 >> 2] = e, w[n.Pa + 8 >> 2] = a, d1 = t, d1;
    }, e: (t) => {
      throw d1 || (d1 = t), d1;
    }, T: () => {
    }, Q: () => {
      ...
      var e = O1[t];
      delete O1[t];
      var a = e.ib, n = e.Ya, o = e.lb, h = o.map((l) => l.ub).concat(o.map((l) => l.Ab));
      e1([t], h, (l) => {
        var c = {};
        return o.forEach((u, f) => {
          var _ = l[f], m = u.sb, C = u.tb, U = l[f + o.length], I = u.zb, S = u.Bb;
          c[u.pb] = { read: (Q) => _.fromWireType(m(C, Q)), write: (Q, P1) => {
            var j = [];
            I(S, Q, U.toWireType(j, P1)), q1(j);
          } };
          ...
          var m = a();
          for (_ in c) c[_].write(m, f[_]);
          return u !== null && u.push(n, m), m;
        }, Wa: 8, readValueFromPointer: w1, Xa: n }];
      });
    }, H: () => {
    }, fa: (t, e, a, n) => {
      e = O(e), V(t, { name: e, fromWireType: function(o) {
        return !!o;
      }, toWireType: function(o, h) {
        return h ? a : n;
      }, Wa: 8, readValueFromPointer: function(o) {
        return this.fromWireType(M[o]);
      }, Xa: null });
    }, u: (t, e, a, n, o, h, l, c, u, f, _, m, C) => {
      _ = O(_), h = W(o, h), c && (c = W(l, c)), f && (f = W(u, f)), C = W(m, C);
      var U = s3(_);
      Z1(U, function() {
        A1(`Cannot construct ${_} due to unbound types`, [n]);
      }), e1([t, e, a], n ? [n] : [], (I) => {
        if (I = I[0], n) var S = I.Qa, Q = S.$a;
        else Q = R1.prototype;
        I = C1(_, function(...d2) {
          if (Object.getPrototypeOf(this) !== P1) throw new g("Use 'new' to construct " + _);
          if (j.Za === void 0) throw new g(_ + " has no accessible constructor");
          var z2 = j.Za[d2.length];
          if (z2 === void 0) throw new g(`Tried to invoke ctor of ${_} with invalid number of parameters (${d2.length}) - expected (${Object.keys(j.Za).toString()}) parameters instead!`);
          return z2.apply(this, d2);
        });
        var P1 = Object.create(Q, { constructor: { value: I } });
        I.prototype = P1;
        var j = new h3(_, I, P1, C, S, h, c, f);
        if (j.Ua) {
          var S1;
          (S1 = j.Ua).jb ?? (S1.jb = []), j.Ua.jb.push(j);
        }
        return S = new b1(_, j, true, false, false), S1 = new b1(_ + "*", j, false, false, false), Q = new b1(_ + " const*", j, false, true, false), C2[t] = { pointerType: S1, nb: Q }, M2(U, I), [S, S1, Q];
      });
    }, t: (t, e, a, n, o, h) => {
      var l = K1(e, a);
      o = W(n, o), e1([], [t], (c) => {
        ...
        if (c.Qa.Za === void 0 && (c.Qa.Za = []), c.Qa.Za[e - 1] !== void 0) throw new g(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${c.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return c.Qa.Za[e - 1] = () => {
          A1(`Cannot construct ${c.name} due to unbound types`, l);
        }, e1([], l, (f) => (f.splice(1, 0, null), c.Qa.Za[e - 1] = t2(u, f, null, o, h), [])), [];
      });
    }, h: (t, e, a, n, o, h, l, c) => {
      var u = K1(a, n);
      e = O(e), e = S2(e), h = W(o, h), e1([], [t], (f) => {
        function _() {
          A1(`Cannot call ${m} due to unbound types`, u);
        }
        f = f[0];
        var m = `${f.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), c && f.Qa.xb.push(e);
        var C = f.Qa.$a, U = C[e];
        return U === void 0 || U.Sa === void 0 && U.className !== f.name && U.ab === a - 2 ? (_.ab = a - 2, _.className = f.name, C[e] = _) : (b2(C, e, m), C[e].Sa[a - 2] = _), e1([], u, (I) => (I = t2(m, I, f, h, l), C[e].Sa === void 0 ? (I.ab = a - 2, C[e] = I) : C[e].Sa[a - 2] = I, [])), [];
      });
    }, da: (t) => V(t, E2), y: (t, e, a, n) => {
      function o() {
      }
      e = O(e), o.values = {}, V(t, { name: e, constructor: o, fromWireType: function(h) {
        return this.constructor.values[h];
      }, toWireType: (h, l) => l.value, Wa: 8, readValueFromPointer: v3(e, a, n), Xa: null }), Z1(e, o);
    }, l: (t, e, a) => {
      var n = $1(t, "enum");
      e = O(e), t = n.constructor, n = Object.create(n.constructor.prototype, { value: { value: a }, constructor: { value: C1(`${n.name}_${e}`, function() {
      }) } }), t.values[a] = n, t[e] = n;
    }, E: (t, e, a) => {
      e = O(e), V(t, { name: e, fromWireType: (n) => n, toWireType: (n, o) => o, Wa: 8, readValueFromPointer: m3(e, a), Xa: null });
    }, v: (t, e, a, n, o, h) => {
      var l = K1(e, a);
      t = O(t), t = S2(t), o = W(n, o), Z1(t, function() {
        A1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), e1([], l, (c) => (M2(t, t2(t, [c[0], null].concat(c.slice(1)), null, o, h), e - 1), []));
    }, p: (t, e, a, n, o) => {
      if (e = O(e), o === -1 && (o = 4294967295), o = (c) => c, n === 0) {
        var h = 32 - 8 * a;
        o = (c) => c << h >>> h;
      }
      ...
      V(t, { name: e, fromWireType: o, toWireType: l, Wa: 8, readValueFromPointer: p3(e, a, n !== 0), Xa: null });
    }, k: (t, e, a) => {
      function n(h) {
        return new o(B.buffer, w[h + 4 >> 2], w[h >> 2]);
      }
      var o = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][e];
      a = O(a), V(t, { name: a, fromWireType: n, Wa: 8, readValueFromPointer: n }, { vb: true });
    }, x: (t) => {
      V(t, g3);
    }, la: (t, e, a, n, o, h, l, c, u, f, _, m) => {
      a = O(a), h = W(o, h), c = W(l, c), f = W(u, f), m = W(_, m), e1([t], [e], (C) => (C = C[0], [new b1(a, C.Qa, false, false, true, C, n, h, c, f, m)]));
    }, ea: (t, e) => {
      e = O(e), V(t, { name: e, fromWireType: function(a) {
        for (var n = w[a >> 2], o = a + 4, h, l = o, c = 0; c <= n; ++c) {
          var u = o + c;
          (c == n || M[u] == 0) && (l = l ? p1(M, l, u - l) : "", h === void 0 ? h = l : (h += "\0", h += l), l = u + 1);
        }
        return Z(a), h;
        ...
        else for (h = 0; h < o; ++h) M[c + h] = n[h];
        return a !== null && a.push(Z, l), l;
      }, Wa: 8, readValueFromPointer: w1, Xa(a) {
        Z(a);
      } });
    }, A: (t, e, a) => {
      if (a = O(a), e === 2) var n = w3, o = y3, h = L3, l = (c) => J[c >> 1];
      else e === 4 && (n = C3, o = b3, h = M3, l = (c) => w[c >> 2]);
      V(t, { name: a, fromWireType: (c) => {
        for (var u = w[c >> 2], f, _ = c + 4, m = 0; m <= u; ++m) {
          var C = c + 4 + m * e;
          (m == u || l(C) == 0) && (_ = n(_, C - _), f === void 0 ? f = _ : (f += "\0", f += _), _ = C + e);
        }
        return Z(c), f;
      }, toWireType: (c, u) => {
      ...
      }, Wa: 8, readValueFromPointer: w1, Xa(c) {
        Z(c);
      } });
    }, s: (t, e, a, n, o, h) => {
      O1[t] = { name: O(e), ib: W(a, n), Ya: W(o, h), lb: [] };
    }, m: (t, e, a, n, o, h, l, c, u, f) => {
      O1[t].lb.push({ pb: O(e), ub: a, sb: W(n, o), tb: h, Ab: l, zb: W(c, u), Bb: f });
    }, ga: (t, e) => {
      e = O(e), V(t, { Db: true, name: e, Wa: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, O: () => {
      X1 = false, n2 = 0;
      ...
      throw 1 / 0;
    }, F: (t, e, a) => (t = W1(t), e = $1(e, "emval::as"), F2(e, a, t)), ja: (t, e, a, n) => (t = r2[t], e = W1(e), t(null, e, a, n)), M: i2, ia: (t, e, a) => {
      var n = P3(t, e), o = n.shift();
      t--;
      var h = Array(t);
      return e = `methodCaller<(${n.map((l) => l.name).join(", ")}) => ${o.name}>`, I3(C1(e, (l, c, u, f) => {
        for (var _ = 0, m = 0; m < t; ++m) h[m] = n[m].readValueFromPointer(f + _), _ += n[m].Wa;
        return l = a === 1 ? S3(c, h) : c.apply(l, h), F2(o, u, l);
      }));
    }, ka: (t) => {
      9 < t && (Y[t + 1] += 1);
    }, ha: (t) => {
      var e = W1(t);
      q1(e), i2(t);
    }, r: (t, e) => (t = $1(t, "_emval_take_value"), t = t.readValueFromPointer(e), x1(t)), K: (t, e) => {
      if (M1[t] && (clearTimeout(M1[t].id), delete M1[t]), !e) return 0;
      var a = setTimeout(() => {
        delete M1[t], E3(() => x2(t, performance.now()));
      }, e);
      return M1[t] = { id: a, Eb: e }, 0;
    }, L: (t, e, a, n) => {
      ...
      var a = 0;
      return T2().forEach((n, o) => {
        var h = e + a;
        for (o = w[t + 4 * o >> 2] = h, h = 0; h < n.length; ++h) B[o++] = n.charCodeAt(h);
        B[o] = 0, a += n.length + 1;
      }), 0;
    }, _: (t, e) => {
      var a = T2();
      ...
      for (var o = 0, h = 0; h < a; h++) {
        ...
        e += 8;
        for (var u = 0; u < c; u++) {
          var f = t, _ = M[l + u], m = D3[f];
          _ === 0 || _ === 10 ? ((f === 1 ? u1 : $)(p1(m)), m.length = 0) : m.push(_);
        }
        o += c;
      }
      return w[n >> 2] = o, 0;
    }, $: Q3, aa: V3, J: N3, j: W3, i: B3, g: z3, ba: T3, z: H3, C: j3, D: $3, a: k3, b: R3, f: A3, o: U3, q: x3, G: X3, Y: k2, P: (t, e) => (R2(M.subarray(t, t + e)), 0) }, y;
    (async function() {
      function t(n) {
        return y = n.exports, q = y.ma, i1(), D = y.ra, H.unshift(y.na), a1--, s.monitorRunDependencies?.(a1), a1 == 0 && m1 && (n = m1, m1 = null, n()), y;
      }
      a1++, s.monitorRunDependencies?.(a1);
      var e = { a: O3 };
      if (s.instantiateWasm) try {
        return s.instantiateWasm(e, t);
      } catch (n) {
        $(`Module.instantiateWasm callback failed with error: ${n}`), P(n);
      }
      F1 ?? (F1 = v2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : s.locateFile ? s.locateFile("DotLottiePlayer.wasm", E) : E + "DotLottiePlayer.wasm");
      try {
        var a = await i3(e);
    ...
    var h2 = (t) => (h2 = y.oa)(t), W2 = (t) => (W2 = y.pa)(t), Z = (t) => (Z = y.qa)(t), x2 = (t, e) => (x2 = y.sa)(t, e), k = (t, e) => (k = y.ta)(t, e), I1 = (t) => (I1 = y.ua)(t), T = (t) => (T = y.va)(t), R = () => (R = y.wa)(), $2 = (t, e, a) => ($2 = y.xa)(t, e, a);
    s.dynCall_iijj = (t, e, a, n, o, h) => (s.dynCall_iijj = y.ya)(t, e, a, n, o, h), s.dynCall_vijj = (t, e, a, n, o, h) => (s.dynCall_vijj = y.za)(t, e, a, n, o, h), s.dynCall_jiii = (t, e, a, n) => (s.dynCall_jiii = y.Aa)(t, e, a, n);
    var U2 = s.dynCall_vijjjj = (t, e, a, n, o, h, l, c, u, f) => (U2 = s.dynCall_vijjjj = y.Ba)(t, e, a, n, o, h, l, c, u, f);
    s.dynCall_jii = (t, e, a) => (s.dynCall_jii = y.Ca)(t, e, a), s.dynCall_vjii = (t, e, a, n, o) => (s.dynCall_vjii = y.Da)(t, e, a, n, o), s.dynCall_vjfii = (t, e, a, n, o, h) => (s.dynCall_vjfii = y.Ea)(t, e, a, n, o, h), s.dynCall_vjiii = (t, e, a, n, o, h) => (s.dynCall_vjiii = y.Fa)(t, e, a, n, o, h), s.dynCall_vj = (t, e, a) => (s.dynCall_vj = y.Ga)(t, e, a), s.dynCall_vjiiiii = (t, e, a, n, o, h, l, c) => (s.dynCall_vjiiiii = y.Ha)(t, e, a, n, o, h, l, c), s.dynCall_vjiffii = (t, e, a, n, o, h, l, c) => (s.dynCall_vjiffii = y.Ia)(t, e, a, n, o, h, l, c), s.dynCall_vjiiii = (t, e, a, n, o, h, l) => (s.dynCall_vjiiii = y.Ja)(t, e, a, n, o, h, l), s.dynCall_viijii = (t, e, a, n, o, h, l) => (s.dynCall_viijii = y.Ka)(t, e, a, n, o, h, l), s.dynCall_iiiiij = (t, e, a, n, o, h, l) => (s.dynCall_iiiiij = y.La)(t, e, a, n, o, h, l), s.dynCall_iiiiijj = (t, e, a, n, o, h, l, c, u) => (s.dynCall_iiiiijj = y.Ma)(t, e, a, n, o, h, l, c, u), s.dynCall_iiiiiijj = (t, e, a, n, o, h, l, c, u, f) => (s.dynCall_iiiiiijj = y.Na)(t, e, a, n, o, h, l, c, u, f);
    function k3(t, e) {
      var a = R();
      try {
        D.get(t)(e);
      } catch (n) {
        if (T(a), n !== n + 0) throw n;
        k(1, 0);
      }
    }
    function T3(t, e, a, n, o) {
      var h = R();
      try {
        return D.get(t)(e, a, n, o);
      } catch (l) {
        if (T(h), l !== l + 0) throw l;
        k(1, 0);
      }
    }
    function R3(t, e, a) {
    ...
    function j3(t, e, a, n, o, h, l, c) {
      var u = R();
      try {
        return D.get(t)(e, a, n, o, h, l, c);
      } catch (f) {
        if (T(u), f !== f + 0) throw f;
        k(1, 0);
      }
    }
    function z3(t, e, a, n) {
    ...
    function H3(t, e, a, n, o, h) {
      var l = R();
      try {
        return D.get(t)(e, a, n, o, h);
      } catch (c) {
        if (T(l), c !== c + 0) throw c;
        k(1, 0);
      }
    ...
    function X3(t, e, a, n, o, h, l, c, u, f) {
      var _ = R();
      try {
        U2(t, e, a, n, o, h, l, c, u, f);
      } catch (m) {
        if (T(_), m !== m + 0) throw m;
        k(1, 0);
      }
    }
    var j1;
    ...
    function j2() {
      function t() {
        if (!j1 && (j1 = true, s.calledRun = true, !s1)) {
          if (N1(H), p(s), s.onRuntimeInitialized?.(), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
      ...
      if (!(0 < a1)) {
        ...
        N1(E1), 0 < a1 || (s.setStatus ? (s.setStatus("Running..."), setTimeout(() => {
...
v(z1, "_ModulePromise", null), v(z1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${q2}@${X2}/dist/dotlottie-player.wasm`);
var J2 = class {
  constructor() {
  ...
  dispatch(d) {
    this._eventListeners.get(d.type)?.forEach((i) => i(d));
  }
...
var N = class {
  ...
  static observe(d, i) {
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, i), this._observer?.observe(d));
  }
  static unobserve(d) {
    this._observer?.unobserve(d), this._observedCanvases.delete(d), this._observedCanvases.size === 0 && (this._observer?.disconnect(), this._observer = null);
  }
};
v(N, "_observer", null), v(N, "_observedCanvases", /* @__PURE__ */ new Map());
var X = class {
  static _initializeObserver() {
    if (this._observer) return;
    let d = (i) => {
      i.forEach((r) => {
        ...
        this._observedCanvases.set(r.target, [p, z]);
      });
    };
    this._observer = new ResizeObserver(d);
  }
  static observe(d, i) {
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, [i, 0]), this._observer?.observe(d));
  }
  static unobserve(d) {
    ...
    this._observer?.unobserve(d), this._observedCanvases.delete(d), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
v(X, "_observer", null), v(X, "_observedCanvases", /* @__PURE__ */ new Map());
function n0(d) {
...
function H2(d) {
  return K3.every((i) => Object.prototype.hasOwnProperty.call(d, i));
}
function V2(d) {
  if (typeof d == "string") try {
    return H2(JSON.parse(d));
  } catch {
    return false;
  }
  else return H2(d);
...
function o1() {
  return 1 + ((A ? window.devicePixelRatio : 1) - 1) * t0;
}
function Y2(d) {
...
var o0 = (d, i) => d === "contain" ? i.Fit.Contain : d === "cover" ? i.Fit.Cover : d === "fill" ? i.Fit.Fill : d === "fit-height" ? i.Fit.FitHeight : d === "fit-width" ? i.Fit.FitWidth : i.Fit.None;
var s0 = (d, i) => {
...
var f2 = (d, i) => d ? { align: s0(d.align ?? [0.5, 0.5], i), fit: o0(d.fit ?? "contain", i) } : i.createDefaultLayout();
var Z2 = class b {
  constructor(i) {
    v(this, "_canvas"), v(this, "_context", null), v(this, "_eventManager"), v(this, "_animationFrameId", null), v(this, "_frameManager"), v(this, "_dotLottieCore", null), v(this, "_renderConfig", {}), v(this, "_isFrozen", false), v(this, "_backgroundColor", null), v(this, "_pointerUpMethod"), v(this, "_pointerDownMethod"), v(this, "_pointerMoveMethod"), v(this, "_pointerEnterMethod"), v(this, "_pointerExitMethod"), this._canvas = i.canvas, this._eventManager = new J2(), this._frameManager = new G3(), this._renderConfig = { ...i.renderConfig, devicePixelRatio: i.renderConfig?.devicePixelRatio || o1(), freezeOnOffscreen: i.renderConfig?.freezeOnOffscreen ?? true }, z1.load().then((r) => {
      b._wasmModule = r, this._dotLottieCore = new r.DotLottiePlayer({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, mode: l2(i.mode ?? "forward", r), segment: u2(i.segment ?? [], r), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: f2(i.layout, r) }), this._eventManager.dispatch({ type: "ready" }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), i.backgroundColor && this.setBackgroundColor(i.backgroundColor);
    }).catch((r) => {
  ...
  async _fetchData(i) {
    ...
    return B2(s) ? s : new TextDecoder().decode(s);
  }
  _loadFromData(i) {
    if (this._dotLottieCore === null) return;
    let r = this._canvas.width, s = this._canvas.height, p = false;
    if (typeof i == "string") {
      if (!V2(i)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      p = this._dotLottieCore.loadAnimationData(i, r, s);
  ...
  get layout() {
    ...
    if (i) return { align: [i.align.get(0), i.align.get(1)], fit: (() => {
      switch (i.fit) {
        case b._wasmModule?.Fit.Contain:
          return "contain";
        case b._wasmModule?.Fit.Cover:
          return "cover";
        case b._wasmModule?.Fit.Fill:
          return "fill";
        case b._wasmModule?.Fit.FitHeight:
          return "fit-height";
        case b._wasmModule?.Fit.FitWidth:
          return "fit-width";
        case b._wasmModule?.Fit.None:
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return i === b._wasmModule?.Mode.Reverse ? "reverse" : i === b._wasmModule?.Mode.Bounce ? "bounce" : i === b._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(i) {
    this._dotLottieCore === null || b._wasmModule === null || (this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, mode: l2(i.mode ?? "forward", b._wasmModule), segment: u2(i.segment ?? [], b._wasmModule), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: f2(i.layout, b._wasmModule) }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor(i.backgroundColor ?? ""));
  }
  _render() {
    ...
    if (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (this._context = this._canvas.getContext("2d")), this._dotLottieCore.render()) {
      if (this._context) {
        let i = this._dotLottieCore.buffer(), r = this._canvas.width * this._canvas.height * e0;
        if (i.byteLength !== r) return console.warn(`Buffer size mismatch: got ${i.byteLength}, expected ${r}`), false;
        let s = null, p = new Uint8ClampedArray(i, 0, i.byteLength);
        typeof ImageData > "u" ? (s = this._context.createImageData(this._canvas.width, this._canvas.height), s.data.set(p)) : s = new ImageData(p, this._canvas.width, this._canvas.height), this._context.putImageData(s, 0, 0);
      }
  ...
  setBackgroundColor(i) {
    this._dotLottieCore !== null && (A && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: r0(i) }), this._backgroundColor = i);
  }
  setLoop(i) {
  ...
  destroy() {
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), A && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), X.unobserve(this._canvas)), this._dotLottieCore?.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  setSegment(i, r) {
    this._dotLottieCore === null || b._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: u2([i, r], b._wasmModule) });
  }
  setMode(i) {
    this._dotLottieCore === null || b._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: l2(i, b._wasmModule) });
  }
  setRenderConfig(i) {
    let { devicePixelRatio: r, freezeOnOffscreen: s, ...p } = i;
    this._renderConfig = { ...this._renderConfig, ...p, devicePixelRatio: r || o1(), freezeOnOffscreen: s ?? true }, A && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? X.observe(this._canvas, this) : X.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? N.observe(this._canvas, this) : (N.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
  ...
  markers() {
    ...
    if (i) {
      ...
      for (let s = 0; s < i.size(); s += 1) {
        let p = i.get(s);
        r.push({ name: p.name, time: p.time, duration: p.duration });
      }
      return r;
    }
    return [];
  ...
  setLayout(i) {
    this._dotLottieCore === null || b._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: f2(i, b._wasmModule) });
  }
  setViewport(i, r, s, p) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(i, r, s, p);
  }
  static setWasmUrl(i) {
    z1.setWasmUrl(i);
  }
  loadStateMachine(i) {
    return this._dotLottieCore?.stateMachineLoad(i) ?? false;
  }
  startStateMachine() {
    if (b._wasmModule === null || this._dotLottieCore === null) return false;
    let i = b._wasmModule.createDefaultOpenURL(), r = this._dotLottieCore.stateMachineStart(i);
    return r && this._setupStateMachineListeners(), r;
  }
  stopStateMachine() {
    let i = this._dotLottieCore?.stateMachineStop() ?? false;
    return i && this._cleanupStateMachineListeners(), i;
  }
  _getPointerPosition(i) {
    let r = this._canvas.getBoundingClientRect(), s = this._canvas.width / r.width, p = this._canvas.height / r.height, P = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, z = (i.clientX - r.left) * s / P, F = (i.clientY - r.top) * p / P;
    return { x: z, y: F };
  }
  _onPointerUp(i) {
  ...
  postPointerUpEvent(i, r) {
    return this._dotLottieCore?.stateMachinePostPointerUpEvent(i, r);
  }
  postPointerDownEvent(i, r) {
    return this._dotLottieCore?.stateMachinePostPointerDownEvent(i, r);
  }
  postPointerMoveEvent(i, r) {
    return this._dotLottieCore?.stateMachinePostPointerMoveEvent(i, r);
  }
  postPointerEnterEvent(i, r) {
    return this._dotLottieCore?.stateMachinePostPointerEnterEvent(i, r);
  }
  postPointerExitEvent(i, r) {
    return this._dotLottieCore?.stateMachinePostPointerExitEvent(i, r);
  }
  ...
  loadStateMachineData(i) {
    return this._dotLottieCore?.stateMachineLoadData(i) ?? false;
  }
  animationSize() {
    let i = this._dotLottieCore?.animationSize().get(0) ?? 0, r = this._dotLottieCore?.animationSize().get(1) ?? 0;
    return { width: i, height: r };
  }
  setStateMachineBooleanContext(i, r) {
    return this._dotLottieCore?.stateMachineSetBooleanInput(i, r) ?? false;
  }
  setStateMachineNumericContext(i, r) {
    return this._dotLottieCore?.stateMachineSetNumericInput(i, r) ?? false;
  }
  setStateMachineStringContext(i, r) {
    return this._dotLottieCore?.stateMachineSetStringInput(i, r) ?? false;
  }
  getLayerBoundingBox(i) {
    let r = this._dotLottieCore?.getLayerBounds(i);
    if (!r || r.size() !== 8) return;
    let s = [];
    for (let p = 0; p < 8; p += 1) s.push(r.get(p));
    return s;
  }
  static transformThemeToLottieSlots(i, r) {
    return b._wasmModule?.transformThemeToLottieSlots(i, r) ?? "";
  }
};
v(Z2, "_wasmModule", null);
var B1 = Z2;
var h0 = class {
  constructor() {
...
var c0 = class {
  constructor() {
    v(this, "_workers", /* @__PURE__ */ new Map()), v(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(d) {
    return this._workers.has(d) || this._workers.set(d, new d0()), this._workers.get(d);
  }
...
var _2 = class r1 {
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), A && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !Y2(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setRenderConfig(i) {
    ...
    let { devicePixelRatio: r, freezeOnOffscreen: s, ...p } = i;
    await this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...p, devicePixelRatio: r || o1(), freezeOnOffscreen: s ?? true } }), await this._updateDotLottieInstanceState(), A && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? X.observe(this._canvas, this) : X.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? N.observe(this._canvas, this) : (N.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  ...
  async resize() {
    if (!this._created) return;
    let { height: i, width: r } = Q2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || o1());
    await this._sendMessage("resize", { height: i, instanceId: this._id, width: r }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), r1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), A && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), X.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setViewport(i, r, s, p) {
    return this._created ? this._sendMessage("setViewport", { x: i, y: r, width: s, height: p, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage("animationSize", { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async _sendMessage(i, r, s) {
    let p = { id: `dotlottie-request-${N2()}`, method: i, params: r };
    return this._worker.postMessage(p, s || []), new Promise((P, z) => {
      let F = (G) => {
        let E = G.data;
        E.id === p.id && (this._worker.removeEventListener("message", F), E.error ? z(new Error(`Failed to execute method ${i}: ${E.error}`)) : P(E.result));
      };
  ...
  _getPointerPosition(i) {
    let r = this._canvas.getBoundingClientRect(), s = this._canvas.width / r.width, p = this._canvas.height / r.height, P = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, z = (i.clientX - r.left) * s / P, F = (i.clientY - r.top) * p / P;
    return { x: z, y: F };
  }
  _onPointerUp(i) {
    let { x: r, y: s } = this._getPointerPosition(i);
...
v(_2, "_workerManager", new c0()), v(_2, "_wasmUrl", "");
var H1 = _2;
var Q1 = ({ animationId: d, autoplay: i, backgroundColor: r, className: s, createDotLottie: p, data: P, dotLottieRefCallback: z, layout: F, loop: G, mode: E, playOnHover: l1, renderConfig: u1, segment: $, speed: K, src: q, style: s1, themeData: h1, themeId: B, useFrameInterpolation: M, workerId: t1, ...J }) => {
  let L = (0, import_react.useRef)(null), w = (0, import_react.useRef)(null), f1 = (0, import_react.useRef)(z), _1 = { speed: K, mode: E, loop: G, useFrameInterpolation: M, segment: $, backgroundColor: r, autoplay: i, themeId: B, workerId: t1, src: q, data: P, layout: F, renderConfig: u1, animationId: d }, i1 = (0, import_react.useRef)(_1);
  f1.current = z, i1.current = _1;
  let E1 = (0, import_react.useCallback)((H) => {
    w.current = H, H ? L.current = p({ ...i1.current, canvas: H }) : (L.current?.destroy(), L.current = null), f1.current?.(L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let H = (v1) => {
      l1 && (v1.type === "mouseenter" && L.current?.play(), v1.type === "mouseleave" && L.current?.pause());
    };
    return w.current?.addEventListener("mouseenter", H), w.current?.addEventListener("mouseleave", H), () => {
      w.current?.removeEventListener("mouseenter", H), w.current?.removeEventListener("mouseleave", H);
    };
  }, [l1]), (0, import_react.useEffect)(() => {
    L.current?.setSpeed(K ?? 1);
  }, [K]), (0, import_react.useEffect)(() => {
    L.current?.setMode(E ?? "forward");
  }, [E]), (0, import_react.useEffect)(() => {
    L.current?.setLoop(G ?? false);
  }, [G]), (0, import_react.useEffect)(() => {
    L.current?.setUseFrameInterpolation(M ?? true);
  }, [M]), (0, import_react.useEffect)(() => {
    typeof $?.[0] == "number" && typeof $[1] == "number" && L.current?.setSegment($[0], $[1]);
  }, [$]), (0, import_react.useEffect)(() => {
    L.current?.setBackgroundColor(r ?? "");
  }, [r]), (0, import_react.useEffect)(() => {
    L.current?.setRenderConfig(u1 ?? {});
  }, [JSON.stringify(u1)]), (0, import_react.useEffect)(() => {
    typeof P != "string" && typeof P != "object" || L.current?.load({ data: P, ...i1.current });
  }, [P]), (0, import_react.useEffect)(() => {
    typeof q == "string" && L.current?.load({ src: q, ...i1.current });
  }, [q]), (0, import_react.useEffect)(() => {
    L.current?.setMarker(J.marker ?? "");
  }, [J.marker]), (0, import_react.useEffect)(() => {
    L.current?.loadAnimation(d ?? "");
  }, [d]), (0, import_react.useEffect)(() => {
    typeof B == "string" && L.current?.setTheme(B);
  }, [B]), (0, import_react.useEffect)(() => {
    L.current?.setThemeData(h1 ?? "");
  }, [h1]), (0, import_react.useEffect)(() => {
    L.current?.setLayout(F ?? {});
  }, [F?.fit, F?.align && F.align[0], F?.align && F.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: s, ...!s && { style: { width: "100%", height: "100%", lineHeight: 0, ...s1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: E1, style: { width: "100%", height: "100%" }, ...J }) });
};
var u0 = (d) => new B1(d);
var T0 = (d) => (0, import_jsx_runtime.jsx)(Q1, { ...d, createDotLottie: u0 });
var _0 = (d) => new H1(d);
var $0 = (d) => (0, import_jsx_runtime.jsx)(Q1, { ...d, createDotLottie: _0 });
var B0 = (d) => {
  H1.setWasmUrl(d), B1.setWasmUrl(d);
};
export {
  T0 as DotLottieReact,
  $0 as DotLottieWorkerReact,
  B0 as setWasmUrl
};
